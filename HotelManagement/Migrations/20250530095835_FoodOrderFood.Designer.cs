...
namespace HotelManagement.Migrations
{
    ...
    [Migration("20250530095835_FoodOrderFood")]
    partial class FoodOrderFood
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HotelManagement.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3ab96b3e-5da7-431b-ab20-90683e572f8a",
                            Email = "user1@example.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "USER1@EXAMPLE.COM",
                            NormalizedUserName = "USER1",
                            PasswordHash = "AQAAAAIAAYagAAAAECY8Yx1Vu7sbmDsYX8YpB+2MMpM08ME3d0FA5xR2RrFh2Rx5awe7haANoglQ3+Juow==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "d2c766e4-a087-42a3-b535-eb54a50cb14e",
                            Email = "user2@example.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "USER2@EXAMPLE.COM",
                            NormalizedUserName = "USER2",
                            PasswordHash = "AQAAAAIAAYagAAAAEPme093W6wxeNRcd6HnafAjZxMxc3h6JGe5d9uqkYIbzBb0n+6ifR54sQxcIs91kPQ==",
                            PhoneNumberConfirmed = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3c8ae24b-12fe-4737-8adb-f26f4c780466",
                            Email = "user3@example.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "USER3@EXAMPLE.COM",
                            NormalizedUserName = "USER3",
                            PasswordHash = "AQAAAAIAAYagAAAAEGmrwC8MFKhWbKpxnyxgXZtwZS21tWBH2BDl7up8OXJiLwc/3eYUsoJKQ3QRDaBV5Q==",
                            PhoneNumberConfirmed = false,
            ...
            modelBuilder.Entity("HotelManagement.Models.FoodOrder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApplicationUserId = new Guid("67019a3d-04de-444b-bb6c-6ef934dcd291"),
                            Description = "Order 1",
                            OrderDate = new DateTime(2025, 5, 30, 12, 58, 34, 763, DateTimeKind.Local).AddTicks(2654),
                            RoomId = new Guid("a242ae42-b5f3-417e-9277-b89ac16fca21"),
                            Status = 0
                        },
                        new
                        {
                            ...
                            ApplicationUserId = new Guid("67019a3d-04de-444b-bb6c-6ef934dcd291"),
                            Description = "Order 2",
                            OrderDate = new DateTime(2025, 5, 30, 12, 58, 34, 765, DateTimeKind.Local).AddTicks(5451),
                            RoomId = new Guid("a242ae42-b5f3-417e-9277-b89ac16fca22"),
                            Status = 2
                        });
                });
            ...
            modelBuilder.Entity("HotelManagement.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Rating = 9,
                            ReviewDate = new DateTime(2025, 5, 30, 12, 58, 34, 766, DateTimeKind.Local).AddTicks(6916),
                            RoomId = new Guid("a242ae42-b5f3-417e-9277-b89ac16fca21")
                        },
                        new
                        {
                            ...
                            FoodId = new Guid("a9063d88-88c6-40db-a7e9-868afeb45811"),
                            Rating = 7,
                            ReviewDate = new DateTime(2025, 5, 30, 12, 58, 34, 766, DateTimeKind.Local).AddTicks(7385)
                        },
                        new
                        {
                            ...
                            Rating = 5,
                            ReviewDate = new DateTime(2025, 5, 30, 12, 58, 34, 766, DateTimeKind.Local).AddTicks(7401),
                            RoomId = new Guid("a242ae42-b5f3-417e-9277-b89ac16fca22")
                        },
                        new
                        {
                            ...
                            FoodId = new Guid("a9063d88-88c6-40db-a7e9-868afeb45812"),
                            Rating = 8,
                            ReviewDate = new DateTime(2025, 5, 30, 12, 58, 34, 766, DateTimeKind.Local).AddTicks(7412)
                        });
                });
