...
namespace HotelManagement.Migrations
{
    ...
    [Migration("20250530102823_KitchenStaff")]
    partial class KitchenStaff
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HotelManagement.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "beb17b4c-9768-4bda-8464-73effeb52bc1",
                            Email = "user1@example.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "USER1@EXAMPLE.COM",
                            NormalizedUserName = "USER1",
                            PasswordHash = "AQAAAAIAAYagAAAAEDYDWlqkIvFA1DaMOOAdtkGhWk8ZMpceTpGCyx3uyhXCfsY6DmHtm5XJIL4IC5RlOg==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "92b0f463-1aa6-4f51-98e6-6ff1a43e759c",
                            Email = "user2@example.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "USER2@EXAMPLE.COM",
                            NormalizedUserName = "USER2",
                            PasswordHash = "AQAAAAIAAYagAAAAELHwDMhOAbf0IykmrnuXqUIgGkrovjHfnavHga/31A3Ah0uKXU82CW7gX0SvK2DDgg==",
                            PhoneNumberConfirmed = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "69a1e924-cfa0-4c0e-9462-00eee92cefef",
                            Email = "user3@example.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "USER3@EXAMPLE.COM",
                            NormalizedUserName = "USER3",
                            PasswordHash = "AQAAAAIAAYagAAAAEEzbwbvhk4rypU5gtQHn8/onVls4fTJZbe4ccUBmXvO0CKS9poGjiQW8kFmYOKEWJw==",
                            PhoneNumberConfirmed = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3f0b9396-2ea4-4154-b615-33d21759bade",
                            Email = "user4@example.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "USER4@EXAMPLE.COM",
                            NormalizedUserName = "USER4",
                            PasswordHash = "AQAAAAIAAYagAAAAEB68YtMVL9DKCRl81XPGlulMgUx46uBj7qHk76fh9jch9mMXGTwWMeV1oWZ9hDtyow==",
                            PhoneNumberConfirmed = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a16b5374-9ddc-47e9-b036-225c099ba221",
                            Email = "user5@example.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "USER5@EXAMPLE.COM",
                            NormalizedUserName = "USER5",
                            PasswordHash = "AQAAAAIAAYagAAAAEBSH29Dqvls/QU47+xSW/ayjvnaYTIz0d7ul55rOq3I5cCYtRohC8OturggMLpCh0A==",
                            PhoneNumberConfirmed = false,
            ...
            modelBuilder.Entity("HotelManagement.Models.FoodOrder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApplicationUserId = new Guid("67019a3d-04de-444b-bb6c-6ef934dcd291"),
                            Description = "Order 1",
                            OrderDate = new DateTime(2025, 5, 30, 13, 28, 22, 331, DateTimeKind.Local).AddTicks(8302),
                            RoomId = new Guid("a242ae42-b5f3-417e-9277-b89ac16fca21"),
                            Status = 0
                        },
                        new
                        {
                            ...
                            ApplicationUserId = new Guid("67019a3d-04de-444b-bb6c-6ef934dcd291"),
                            Description = "Order 2",
                            OrderDate = new DateTime(2025, 5, 30, 13, 28, 22, 334, DateTimeKind.Local).AddTicks(2717),
                            RoomId = new Guid("a242ae42-b5f3-417e-9277-b89ac16fca22"),
                            Status = 2
                        });
                });
            ...
            modelBuilder.Entity("HotelManagement.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Rating = 9,
                            ReviewDate = new DateTime(2025, 5, 30, 13, 28, 22, 335, DateTimeKind.Local).AddTicks(4580),
                            RoomId = new Guid("a242ae42-b5f3-417e-9277-b89ac16fca21")
                        },
                        new
                        {
                            ...
                            FoodId = new Guid("a9063d88-88c6-40db-a7e9-868afeb45811"),
                            Rating = 7,
                            ReviewDate = new DateTime(2025, 5, 30, 13, 28, 22, 335, DateTimeKind.Local).AddTicks(5058)
                        },
                        new
                        {
                            ...
                            Rating = 5,
                            ReviewDate = new DateTime(2025, 5, 30, 13, 28, 22, 335, DateTimeKind.Local).AddTicks(5076),
                            RoomId = new Guid("a242ae42-b5f3-417e-9277-b89ac16fca22")
                        },
                        new
                        {
                            ...
                            FoodId = new Guid("a9063d88-88c6-40db-a7e9-868afeb45812"),
                            Rating = 8,
                            ReviewDate = new DateTime(2025, 5, 30, 13, 28, 22, 335, DateTimeKind.Local).AddTicks(5081)
                        });
                });
